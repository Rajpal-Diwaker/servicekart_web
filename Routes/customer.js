...
router.get('/getWalletHistory', authHandler.verifyToken, (req, res) => {
    customerService.getWalletHistory(req.body, req.headers, (data) => {
        res.send(data);
    });
});

/* Get Customer Orders */
router.post('/orderList', authHandler.verifyToken, (req, res) => {
    customerService.orderList(req.body, req.headers, (data) => {
        res.send(data);
    });
});

/* Get Customer Order Detail */
router.post('/getOrderDetails', authHandler.verifyToken, (req, res) => {
    customerService.getOrderDetails(req.body, req.headers, (data) => {
        res.send(data);
    });
});

/* Add wallet amount */
router.post('/addWalletAmount', authHandler.verifyToken, (req, res) => {
    customerService.addWalletAmount(req.body, req.headers, (data) => {
        res.send(data);
    });
});
